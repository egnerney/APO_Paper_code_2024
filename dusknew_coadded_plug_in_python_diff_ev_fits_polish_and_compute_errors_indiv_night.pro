...
pro Dusknew_coadded_plug_in_python_diff_ev_fits_polish_and_compute_errors_indiv_night
...
for iiii = 0, n_elements(nxxx) - 1 do begin
  ...
  dusk_grid = dblarr(current_n_xgrid,8)
  readf,1,dusk_grid
  close,1
  
  openr,1,err_spec_string ;'x_grid_dusk_night5.csv'
  err_dusk_grid = dblarr(current_n_xgrid,8)
  readf,1,err_dusk_grid
  close,1
...
leg22.save,current_night + '_dusk_diffev_python_model_vs_obs.png',resolution=300
...
p8.save,current_night + '_dusk_diffev_python_simult_param_errorplots.png',resolution=300
...
write_csv,current_night + '_dusk_diffev_output_to_plot'+ strtrim(string(current_n_xgrid),1)+'x13.csv',output

save,tec_fixed_found,tec_error,nec_fixed_found,nec_error,nsp_fixed_found,nsp_error,ns2p_fixed_found,ns2p_error,nop_fixed_found,nop_error,x_grid,nspmix_error,ns2pmix_error,nopmix_error,totchmix_for_apo, FILENAME = current_night + '_dusk_diffev_python_simult_param_save_file_simult_errors_from_mpfit_no_polish.sav',/verbose
