...
pro dusk_cm3_fitter_only_7_lines_using_tables
...
totchmix_for_apo = interpol(totchmix_for_apo,rho_ceq_for_totchmix,x_grid)

    
   tec = replicate(4d,n_elements(x_grid))
    
    nec = replicate(2000d,n_elements(x_grid))
...
if (q>0) then begin
  ...
  if (tec[q-1] ge tecupval) then  parinfo[*].value = [4d,2500d,Nsp[q-1],Ns2p[q-1],Nop[q-1]];
endif
...
leg22.save,'spec_sim_cm3_fit_only_7_lines_emiss_tables_Dusk_coadded_0.04res_5pointavg.png',resolution=300
...
p8.save,'given_fixed_sum_ratio_outs_plots_cm3_fit_only_7_lines_emiss_tables_Dusk_coadded_0.04res_5pointavg.png',resolution=300
...
p11113.save,'given_fixed_sum_ratio_LOS_implied_distance_cm3_fit_only_7_lines_emiss_tables_Dusk_coadded_0.04res_5pointavg.png',resolution=300
...
save,tec,tec_error,nec,nec_error,Nsp,Nsp_error,Ns2p,Ns2p_error,Nop,Nop_error,Nspmix,Nspmix_error,Ns2pmix,Ns2pmix_error,Nopmix,Nopmix_error,Nec_column_given_ratio,Nec_column_given_ratio_error,LOS_distance_given_ratio,LOS_distance_given_ratio_error,x_grid,dawn_grid,err_dawn_grid,model, FILENAME = 'save_file_cm3_fit_only_7_lines_emiss_tables_Dusk_coadded_0.04res_5pointavg.sav',/verbose
