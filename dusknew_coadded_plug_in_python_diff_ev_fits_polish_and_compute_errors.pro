...
pro Dusknew_coadded_plug_in_python_diff_ev_fits_polish_and_compute_errors
...
leg22.save,'dusk_diffev_python_model_vs_obs.png',resolution=300
...
p8.save,'dusk_diffev_python_simult_param_errorplots.png',resolution=300
...
write_csv,'dusk_diffev_output_to_plot60x13.csv',output

save,tec_fixed_found,tec_error,nec_fixed_found,nec_error,nsp_fixed_found,nsp_error,ns2p_fixed_found,ns2p_error,nop_fixed_found,nop_error,x_grid,nspmix_error,ns2pmix_error,nopmix_error,totchmix_for_apo, FILENAME = 'dusk_diffev_python_simult_param_save_file_simult_errors_from_mpfit_no_polish.sav',/verbose
