...
pro Dusknew_coadded_plug_in_python_diff_ev_fits_polish_and_compute_errors_cubic_spline_regression_indiv_night
 ...
 ; stop
  ...
  xgrid_strings = ['xgrid_night1_fixed.csv','xgrid_night2_fixed.csv','xgrid_night3_fixed.csv','xgrid_night4_fixed.csv','xgrid_night5_dusk_fixed.csv','xgrid_night6_fixed.csv']
  nightname_strings = ['night1','night2','night3','night4','night5','night6']
  spec_strings = ['Dusk_night1_grid_to_plot_71x8.csv','Dusk_night2_grid_to_plot_71x8.csv','Dusk_night3_grid_to_plot_68x8.csv','Dusk_night4_grid_to_plot_67x8.csv','Dusk_night5_grid_to_plot_66x8.csv','Dusk_night6_grid_to_plot_64x8.csv']

  err_spec_strings =  ['err_Dusk_night1_grid_to_plot_71x8.csv','err_Dusk_night2_grid_to_plot_71x8.csv','err_Dusk_night3_grid_to_plot_68x8.csv','err_Dusk_night4_grid_to_plot_67x8.csv','err_Dusk_night5_grid_to_plot_66x8.csv','err_Dusk_night6_grid_to_plot_64x8.csv']

  infile_strings = ['night1_varypls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_outs_and_errors_dusk_funcform_tec3partpl_python_60x16.csv','night2_varypls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_outs_and_errors_dusk_funcform_tec3partpl_python_60x16.csv',$
    'night3_varypls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_outs_and_errors_dusk_funcform_tec3partpl_python_60x16.csv','night4_varypls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_outs_and_errors_dusk_funcform_tec3partpl_python_60x16.csv', $
    'night5_varypls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_outs_and_errors_dusk_funcform_tec3partpl_python_60x16.csv','night6_varypls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_outs_and_errors_dusk_funcform_tec3partpl_python_60x16.csv']
  nxxx = [71,71,68,67,66,64]
...
leg22.save,current_night + '_lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dusk_diffev_python_model_vs_obs.png',resolution=300
...
p8.save,current_night + '_lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dusk_diffev_python_simult_param_errorplots.png',resolution=300
...
write_csv,current_night + '_lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dusk_diffev_output_to_plot'+ strtrim(string(current_n_xgrid),1)+'x13.csv',output

write_csv,current_night + '_lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dusk_diffev_model_to_plot'+ strtrim(string(current_n_xgrid),1)+'x8.csv',model



save,tec_fixed_found,tec_error,nec_fixed_found,nec_error,nsp_fixed_found,nsp_error,ns2p_fixed_found,ns2p_error,nop_fixed_found,nop_error,x_grid,nspmix_error,ns2pmix_error,nopmix_error,totchmix_for_apo,lambdaa1,lambdaa2, FILENAME = current_night + '_lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dusk_diffev_python_simult_param_save_file_simult_errors_from_mpfit_no_polish.sav',/verbose
;stop
 endfor
    endfor
