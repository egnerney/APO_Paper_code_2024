...
def residuals_function(p, x, y, err, x_grid, x_step_size, yptsi_in_2dto1d, nel2dto1d, tec2dto1d, rhoRne_, rhoORne_, rhocne_, rhoRnsp_, rho4069peak, nec_pl, totchmix_for_apo):
    ...
    for idx in range(nx_grid):
        ...
        if (((ns2p_funcform_test[idx] / nec_funcform_test[idx]) > 0.173) and (x_grid[idx] <= 5.56)):
            flags2p[idx] = 1.
...
if __name__ == '__main__':
    ...
    xtoplot = x_grid[20:46]
    aptochmix_to_plot =  interp1d(np.array([x_grid[20],x_grid[45]]), np.array([totchmix_for_apo[20],totchmix_for_apo[45]]), kind='linear')(xtoplot)
    ...
    p0 = [5.03, 750.,0.198,Hout,600.,Jin,Jout,650.,Din2,Dout2, 350., I2,Jin2,Jout2, A_TE1,B_te1 ,B_te2, A_TE2,5.60,5.706,5.706,5.58,5.82,5.82,6.37,4.13,3.96]
    start_time = time.time()

    bounds = [(5.02, 5.07), (550., 800.), (0.191, 0.5), (0.1, 0.6), (300., 700.), (0.05, 0.5), (0.05, 1.5), (400., 700.), (0.05, 0.8), (0.05, 2.5), (300., 700.), (300., 700.), (0.05, 0.5), (0.05, 2.5), (1., 3.), (0.01, 10.), (0.01, 10.), (3., 8.),(5.55, 5.66), (5.68, 5.75), (5.70, 5.75),(5.25, 5.65), (5.66, 5.95),(5.815,5.90),(3.,10.),(2.,8.),(0.95,8.)]
    ...
    np.savetxt('varpls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_outs_and_errors_dusk_funcform_tec3partpl_python_60x16.csv', output_data, delimiter=',', comments='')
    np.savetxt('varpls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_dusk_funcform_params_pold_tec3partpl_python_23vals.csv', pold, delimiter=',', comments='')
    plt.clf()
    ...
    plt.tight_layout()
    plt.savefig('varpls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_bestfit_params_python_dusk_funcform_tec3partpl.png')
    ...
    np.savetxt('varpls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_model_dusk_funcform_tec3partpl_python_60x8.csv', model_spectra, delimiter=',', comments='')
    plt.clf()
    fig, axs = plt.subplots(8, 1, figsize=(10, 20), sharex=True)
    ...
    plt.ylim([0,400])
    plt.legend(loc='best')
    plt.savefig('varpls_varytec_locs_varyrhoRnsp_and_rhoRns2p_and_nop_diff_ev_bestfit_emiss_for_python_dusk_funcform_tec3partpl.png')
    plt.show()
