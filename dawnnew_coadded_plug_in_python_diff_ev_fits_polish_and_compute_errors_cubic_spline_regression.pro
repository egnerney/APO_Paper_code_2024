...
pro Dawnnew_coadded_plug_in_python_diff_ev_fits_polish_and_compute_errors_cubic_spline_regression
...
p1=plot(x_grid,dawn_grid(*,6)/dawn_grid(*,7),xtitle='DawnDistance ($R_J$)',ytitle='Rayleighs',yrange=[0,1.5],title='black is $S^+$ 6716/6731 and Red is $O^+$ 3729/3726 ',color='black')
...
leg22.save,'lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dawn_diffev_python_model_vs_obs.png',resolution=300
...
p8.save,'lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dawn_diffev_python_simult_param_errorplots.png',resolution=300
...
write_csv,'lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dawn_diffev_output_to_plot60x13.csv',output

write_csv,'lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dawn_diffev_model_to_plot60x8.csv',model



save,tec_fixed_found,tec_error,nec_fixed_found,nec_error,nsp_fixed_found,nsp_error,ns2p_fixed_found,ns2p_error,nop_fixed_found,nop_error,x_grid,nspmix_error,ns2pmix_error,nopmix_error,totchmix_for_apo,lambdaa1,lambdaa2, FILENAME = 'lambda1=' + trimmed_lambdaa1  + '_lambda2=' + trimmed_lambdaa2 + '_CSR_dawn_diffev_python_simult_param_save_file_simult_errors_from_mpfit_no_polish.sav',/verbose
;stop
 endfor
    endfor
